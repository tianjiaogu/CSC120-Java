...
public class RecMain
{
  public static void main( String[] RecMain )
  {
    ...
    Rectangle r1 = new Rectangle( keyboard.nextDouble(),  keyboard.nextDouble(), 
        keyboard.nextDouble(),  keyboard.nextDouble()  );
    System.out.print( "Enter the two corners of rectangle 2: " );
    Rectangle r2 = new Rectangle( keyboard.nextDouble(),  keyboard.nextDouble(), 
        keyboard.nextDouble(),  keyboard.nextDouble()  );
    boolean f = r1.disjoint( r2 );
    System.out.println( ( f ) ? "The rectangles are disjoint."
        : "The rectangels intersects." );
    ...
    if ( !f )
    {
      System.out.printf( "Its distance is %f.\n", r1.distance( x, y ) );
    }
    f = r2.isIn( x, y );
